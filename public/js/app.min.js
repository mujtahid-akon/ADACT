...
success:function(h){if(h.projects&&0<h.projects.length){var k=[],g=h.projects.length;c.text(g);f.addClass("unread-count");d.fadeIn(500);b.show();e.text(g+" notification"+(1===g?"":"s"));h=$jscomp.makeIterator(h.projects);for(g=h.next();!g.done;g=h.next())g=g.value,k.push("<li><a href='./projects/"+g.id+"'><span class='space-after small'>view project#"+g.id+"</span><span class='space-after'>"+g.name+"</span></a></li>");a.html(k.join("<li class='divider'></li>"))}else b.hide(),c.text(""),f.removeClass("unread-count"),
